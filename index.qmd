...
This ensures that embeddings from the same underlying content are positioned closely within the learned space.
...
![Complex Workflow](assets/figs/workflow.jpg)
